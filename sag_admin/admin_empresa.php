                                ...
                                <div id="layoutSidenav_content">
                                    <main>
                                        ...
                                        <div class="row">
                                            ...
                                            <h1 class="mt-4">REGISTRO ADMINISTRADOR</h1>
                                            ...
                                            <i class="fa-solid fa-circle-plus"></i> AGREGAR ADMINISTRADOR
                                            </button><br></br>
                                                        ...
                                                        <form class="row g-3" id="registroUser">
                                                                    <div class="col-md-0">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <select hidden class="form-select" name="rol" id="id_rol">
                                            ...
                                            <!-- TABLA DE EMPRESAS-->
                                        <?php
                                        require ("tables/administradores.php")
                                        ?>
                                    </main>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="col-md-0">
                                                                        <div class="input-group">
                                                                            <!-- <span class="input-group-text" id="inputGroupPrepend2"><i
                                                                                    class="fa-solid fa-hashtag"></i></span> -->
                                                                            <select hidden class="form-select" name="rolU" id="id_rolu">
